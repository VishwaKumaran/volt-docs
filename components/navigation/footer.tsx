    ...
    <footer className="text-foreground flex h-16 w-full flex-wrap items-center justify-center gap-4 border-t px-2 py-3 text-sm sm:justify-between sm:gap-0 sm:px-4 sm:py-0 lg:px-8">
      ...
      {Settings.branding !== false && (
        <div className="hidden items-center md:block">
          <Link
            className="font-semibold"
            href="https://vishwaelankumaran.com"
            title="Vishwa Elankumaran"
            aria-label="Vishwa Elankumaran"
            target="_blank"
          >
            <Image
              src="/logo.svg"
              alt="Vishwa Elankumaran logo"
              title="Vishwa Elankumaran logo"
              aria-label="Vishwa Elankumaran logo"
              priority={false}
              width={30}
              height={30}
            />
